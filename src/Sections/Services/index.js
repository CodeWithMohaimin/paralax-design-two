...
// svg
import serviceOne from "../../assets/Design.svg";
import serviceTwo from "../../assets/Develope.svg";
import serviceThree from "../../assets/Support.svg";
...
const Services = () => {
  ...
  return (
    <ServiceSection id="services">
      <Background ref={ref}>
        <Title className="title">What Mohaimin Do</Title>
        <Line id="line" />
