...
const Footer = () => {
  return (
    <FOOTER>
      ...
      <RightText>
        Reach out to me via 😉
        <a href="https://twitter.com/iammohiamin">
          <img src={Twitter} alt="Twitter" />
        </a>
        &nbsp;
        <a href="https://www.instagram.com/codewithmohaimin/">
          <img src={Instagram} alt="Instagram" />
        </a>
        &nbsp;
        <a href="mailto:codewithmohaimin@gmail.com?subject=Email From Your Website">
